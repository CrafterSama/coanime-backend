...
$base_url = 'http://coanime.net'; //url base of site if you want only relative url leave empty
$upload_dir = '/images/posts/'; // path from base_url to upload base dir
$current_path = '../../../../images/posts/'; // relative path from filemanager folder to upload files folder

$MaxSizeUpload = 1.6; //Mb
